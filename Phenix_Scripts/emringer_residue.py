...
# Modification of emringer_score to calculate residue-subset scores.
...
def main(args):
	for file in args.filenames:
		...
		easy_pickle.dump(file+'.output/Residue_Outliers.pkl',Weird_residues)
		print 'Wrote ' + file+'.output/Residue_Outliers.pkl'
		easy_pickle.dump(file+'.output/residue_rotamer_ratios.pkl', rotamer_ratios)
		print 'Wrote ' + file+'.output/residue_rotamer_ratios.pkl'
		easy_pickle.dump(file+'.output/residue_zscores.pkl', zscores)
		print 'Wrote ' + file+'.output/residue_zscores.pkl'
		easy_pickle.dump(file+'.output/residue_emringer_scores.pkl', [10*i/math.sqrt(length) for i in zscores])
		print 'Wrote ' + file+'.output/residue_emringer_scores.pkl'
		easy_pickle.dump(file+'.output/residue_thresholds.pkl', thresholds)
		print 'Wrote ' + file+'.output/residue_thresholds.pkl'
		easy_pickle.dump(file+'.output/residue_peak_counts.pkl', peak_count)
		print 'Wrote ' + file+'.output/residue_peak_counts.pkl'
		for index, value in enumerate(zscores):
			if value == max(zscores):
				print ""
				print "=====Final Statistics for Model Subset/Map Pair====="
