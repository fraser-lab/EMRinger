...
def main(args):
	for file in args.filenames:
		...
		easy_pickle.dump(file+'.output/sample_sizes.pkl', sample_sizes)
		print 'Wrote ' + file+'.output/sample_sizes.pkl'
...
def plot_peaks(peak_count, filename, threshold, first, title=0):
	...
	print 'Saved plot to %s.output/%.3f.Phenix_allpeaks.png' % (filename,threshold)
